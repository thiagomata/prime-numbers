...
{\raggedright Source: \href{https://github.com/thiagomata/prime-numbers/blob/integral-cycle-article-v1.0.0/src/main/scala/v1/chapter4/cycle/integral/recursive/properties/GapProperties.scala}{\texttt{Gap\allowbreak Properties::assert\allowbreak Mod\allowbreak Is\allowbreak Periodic}}\par}
...
{\raggedright Source: \href{https://github.com/thiagomata/prime-numbers/blob/integral-cycle-article-v1.0.0/src/main/scala/v1/chapter4/cycle/integral/recursive/properties/GapProperties.scala}{\texttt{Gap\allowbreak Properties cycle-period shift lemmas}}\par}
...
\subsection{Unit-Cycle Generation --- \texorpdfstring{\texttt{assert\allowbreak Cycle\allowbreak Integral\allowbreak Of\allowbreak Ones,}\\
\texttt{assert\allowbreak Cycle\allowbreak Integral\allowbreak Of\allowbreak Ones\allowbreak Strictly\allowbreak Increasing}}{assertCycleIntegralOfOnes, assertCycleIntegralOfOnesStrictlyIncreasing}}

{\raggedright Source: \href{https://github.com/thiagomata/prime-numbers/blob/integral-cycle-article-v1.0.0/src/main/scala/v1/chapter4/cycle/integral/recursive/properties/CycleIntegralOnesProperties.scala}{\texttt{Cycle\allowbreak Integral\allowbreak Ones\allowbreak Properties}}\par}
...
\texttt{integral-cycle-article-v1.0.0} and is available at
\href{https://github.com/thiagomata/prime-numbers/blob/integral-cycle-article-v1.0.0/logs/verify-ch-4-v1-chapter4-_.log}{\texttt{logs/verify-ch-4-v1-chapter4-\_.log}}.
