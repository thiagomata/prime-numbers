...
\hypersetup{
  ...
  citecolor=blue,
  urlcolor=blue,
  pdftitle={Formal Verification of Cycle Integral Properties from First Principles},
  pdfauthor={Thiago Henrique Ramos da Mata}
}

\title{Formal Verification of Cycle Integral Properties from First Principles}
\author{%
  ...
  \small Published: \url{https://doi.org/10.5281/zenodo.22868423}
}
\date{}
...
\input{sections/04-core-properties}

\input{sections/05-periodic-properties}

\input{sections/06-deriving}
