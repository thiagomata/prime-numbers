...
\hypersetup{
  ...
  citecolor=blue,
  urlcolor=blue,
  pdftitle={Formal Verification of Discrete Integration Properties from First Principles},
  pdfauthor={Thiago Henrique Ramos da Mata}
}

\title{Formal Verification of Discrete Integration Properties from First Principles}
\author{%
  ...
  \small Published: \url{https://doi.org/10.5281/zenodo.22746792}
}
\date{}
...
\input{sections/05-consistency-lemmas}
