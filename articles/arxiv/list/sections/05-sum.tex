...
\begin{itemize}
  \item \href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{Sum matches summation}:
    $\operatorname{sum}(L) = L[0] + \cdots + L[|L|-1]$
  \item \href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{Left append preserves sum}:
    $\operatorname{sum}(x :: L) = x + \operatorname{sum}(L)$
  \item \href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{Sum over concatenation}:
    $\operatorname{sum}(A \mathbin{\texttt{++}} B) = \operatorname{sum}(A) + \operatorname{sum}(B)$
  \item \href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{Commutativity of sum}:
...
\href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{\texttt{ListUtils::sum}}.
...
\end{aligned} \\
\therefore \\
\operatorname{sum}(x :: L) = x + \operatorname{sum}(L) \quad \blacksquare \quad \text{[Q.E.D.]}
\end{gather*}

{\raggedright
This property is verified in
\href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{\texttt{ListUtils::\allowbreak listSumAddValue}}.
...
{\raggedright
This property is verified in
\href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{\texttt{ListUtils::\allowbreak listCombine}}.
...
{\raggedright
This property is verified in
\href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/ListUtils.scala}{\texttt{ListUtils::\allowbreak listSwap}}.
...
{\raggedright
This property is verified in
\href{https://github.com/thiagomata/prime-numbers/blob/list-article-v1.0.0/src/main/scala/v1/chapter3/list/properties/ListUtilsProperties.scala}{\texttt{ListUtilsProperties::\allowbreak assertSumPositive}}.
\par}
