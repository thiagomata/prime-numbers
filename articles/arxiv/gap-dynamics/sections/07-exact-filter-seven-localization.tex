...
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/filter-seven-harmful-excess-is-boundary-sized.md}{Filter-Seven Harmful Excess Is Boundary-Sized}.
The 21 weights, their zero sum, and all cyclic subsums are not yet encoded
as a \texttt{.holds} theorem.
\par}
