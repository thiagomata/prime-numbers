...
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/safe-window-two-gaps-certify-twin-primes.md}{Safe-Window 2-Gaps Certify Twin Primes}.
No \texttt{.holds} theorem currently encodes the least-prime-divisor argument, so
...
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/two-gap-isolation-after-filter-three.md}{Isolation Of 2-Gaps After Filtering By 3}. No
dedicated \texttt{.holds} theorem currently counts incident 2-gaps per accepted
...
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/exact-accepted-local-filter-strikes.md}{Exact Accepted Local Filter Strikes}. No
\texttt{.holds} theorem currently contains the prime-counting argument; this result
...
supplementary research record is available in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/sharp-local-two-gap-survival-threshold.md}{Sharp Local 2-Gap Survival Threshold}. No
\texttt{.holds} theorem currently encodes the local populations or the prime-counting
