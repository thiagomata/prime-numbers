...
{\raggedright
The derivation above proves the exact product count. A supplementary
research record is available in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/exact-global-two-gap-count.md}{Exact Global 2-Gap Count}.
No \texttt{.holds} theorem currently encodes this exact product count, so
...
research record is available in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/copy-index-filter-frequency.md}{Exact Filter Frequency Across Repeated Copies}.
The repeated-stream foundation is verified in the companion Sieve
Sequence article \cite{mata2026sievesequence}, but no \texttt{.holds}
theorem currently packages these two exact copy-index classes and the
finite-slice bound. This result is not yet Stainless-verified.
\par}
...
complete-period limitation. A supplementary research record is available
in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/exact-batched-two-gap-survival.md}{Exact Batched 2-Gap Survival}.
No corresponding \texttt{.holds} theorem currently packages the
finite-batch product; this result is not yet Stainless-verified.
\par}
...
closed product, and localization boundary. A supplementary research
record is available in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/exact-global-two-gap-cluster-count.md}{Exact Global Count Of \texttt{(2,4,2)} Two-Gap Clusters}.
No \texttt{.holds} theorem currently packages the cyclic cluster count;
this result is not yet Stainless-verified.
\par}
...
every gap value $d$. The rotation invariance itself is proved; the exact
multiplicity claim is not yet Stainless-verified.
...
exact multiplicity theorem above is maintained mathematically in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/rotation-preserves-cyclic-gap-counts.md}{Rotation Preserves Cyclic Gap Counts};
...
its global/local boundary. A supplementary research record is available
in
\href{https://github.com/thiagomata/prime-numbers/blob/master/properties/sieve-sequence/absence-of-two-gaps-is-stable.md}{Absence Of 2-Gaps Is Stable Under Later Filtering}.
No dedicated \texttt{.holds} theorem currently quantifies over the
complete cyclic gap transition, so this result is not yet
Stainless-verified.
\par}
