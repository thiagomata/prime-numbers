...
{\raggedright
The derivation above proves the exact product count. A \par}
...
{\raggedright
The derivation above proves this exact copy-index law. A \par}
...
complete-period limitation. A \par}
...
closed product, and localization boundary. A \par}
...
its global/local boundary. A \par}
