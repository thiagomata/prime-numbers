...
\author{%
  ...
  \small Published: \url{https://doi.org/10.5281/zenodo.22865441}
}
\date{}
...
\input{sections/03-cycle-definitions}

\input{sections/04-cycle-equivalence}

\input{sections/05-cycle-properties}
