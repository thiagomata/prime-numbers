...
1. [Protected endpoints](protected-endpoints.md)
2. [Local surplus](local-surplus.md)
3. [Protected clusters](protected-cluster.md)
4. [Bounded consecutive destruction](bounded-consecutive-destruction.md)
5. [Bounded post-merge spacers](bounded-post-merge-spacer.md)
6. [Controlled merge runs](controlled-merge-run.md)
7. [Balanced spacers](balanced-spacers.md)
8. [Distinguished head spacer](distinguished-head-spacer.md)
9. [Forbidden-copy covered runs](forbidden-copy-covered-run.md)
10. [Short-window discrepancy](short-window-discrepancy.md)
11. [Random-like merge survival](random-like-merge-survival.md)
12. [Local pattern-residue balance](local-pattern-residue-balance.md)
13. [Uniform local observable sampling](uniform-local-observable-sampling.md)
14. [Hereditary shot-spacing capacity](hereditary-shot-spacing-capacity.md)
