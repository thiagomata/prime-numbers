...
15. [Safe-Zone Exhaustion Curve](safe-zone-exhaustion-curve.md)
...
16. [Fixed-k Shot Spacing: Monotonicity and Eventual Stability](stable-small-k-shot-spacing.md)
...
17. [Bounded Pair Separation Gives the k=2 Interval Premise](interval-premise-from-pair-existence.md)
...
18. [A Local Count Forces the k=2 Shot-Capacity Premise](local-count-forces-k2-shot-capacity.md)
...
19. [Exact Seven-Layer Capacity Floor](exact-seven-layer-capacity-floor.md)
...
20. [Local Density Forces a Close-Pair Matching Bound](local-density-forces-close-pair-matching.md)
...
21. [Filtering Attrition Bound for Raw Close Pairs](filtering-attrition-bound-raw-close-pairs.md)
...
22. [Filtering Attrition Bound for Close-Pair Matchings](filtering-attrition-bound-close-pair-matching.md)
...
23. [Harmful Residue Capacity After Filter Three](harmful-residue-capacity-after-filter-three.md)
...
24. [Two-Class Survival From Residue Collision Energy](two-class-survival-from-collision-energy.md)
...
25. [Weighted Collision-Energy Chain Survival](weighted-collision-energy-chain-survival.md)
...
26. [Weighted Deletion Conservation Law](weighted-deletion-conservation-law.md)
...
27. [Two-Gap Pair Local Factor By Separation](two-gap-pair-local-factor-by-separation.md)
...
28. [Complete-Period Two-Gap Pair-Correlation Average](complete-period-two-gap-pair-correlation-average.md)
...
29. [Fourier Bound For Two-Gap Correlation Prefixes](fourier-two-gap-correlation-prefix-bound.md)
    - Factors the complete CRT spectrum, computes exact conductor moments, and
      bounds complete-origin correlation prefixes.
30. [Localized Two-Gap Correlation: Fourier Boundary](localized-two-gap-correlation-fourier-boundary.md)
...
31. [Short-Interval Localization Destroys Prime Conductor Decay](short-interval-localization-destroys-prime-conductor-decay.md)
...
32. [Black-Box Large Sieve Does Not Fit The Weighted Collision Budget](black-box-large-sieve-does-not-fit-weighted-collision-budget.md)
...
33. [First-Deletion Pair Terminal Energy](first-deletion-pair-terminal-energy.md)
...
34. [Two Endpoint Observables Separate Harmful Excess And Imbalance](two-endpoint-observables-separate-harmful-excess-and-imbalance.md)
...
35. [Orthogonal Residue-Energy Decomposition After A Two-Class Filter](orthogonal-residue-energy-decomposition-after-two-class-filter.md)
...
36. [Accepted-Strike Density As A Möbius Boundary Sum](accepted-strike-density-boundary-decomposition.md)
...
37. [Endpoint Density Contracts Accepted-Strike Discrepancy](endpoint-density-contracts-strike-discrepancy.md)
...
38. [Weighted Composition Of Endpoint And Strike-Density Errors](weighted-scalar-error-composition.md)
...
39. [Accepted-Strike Error Is A Positive Quadratic Variation](accepted-strike-quadratic-variation.md)
...
40. [Prime-Square Window Boundary Residue Formula](prime-square-window-boundary-residue-formula.md)
...
41. [Harmless Energy As A Fixed-Set Pair Correlation](harmless-energy-fixed-set-pair-form.md)
    - Rewrites candidate #22 as a post-deletion ordered-pair kernel on `S_0`,
      ...
      telescope.
42. [Complete-Period Uniformity Of Harmless 2-Gap Classes](complete-period-harmless-class-uniformity.md)
...
43. [Harmless Energy As Spectral Excess Above The Two-Class Floor](harmless-energy-spectral-excess.md)
...
44. [Harmless-Class Counts As Translated CRT Fibers](harmless-class-crt-translated-fibers.md)
...
45. [Centered Inverse-Phase Gram Matrix](centered-inverse-phase-gram-matrix.md)
...
46. [Centered Phase Operator Norm Boundary](centered-phase-operator-norm-boundary.md)
...
47. [Exact-Conductor Phase-Block Operator Bound](exact-conductor-phase-block-operator-bound.md)
...
48. [Centered Ramanujan Cross-Conductor Geometry](centered-ramanujan-cross-conductor-geometry.md)
...
49. [Accepted-Strike Divisor Activation Kernel](accepted-strike-divisor-activation-kernel.md)
...
50. [Accepted-Strike CRT Lift-Index Transform](accepted-strike-crt-lift-index-transform.md)
...
51. [Accepted-Strike Summatory Coprime Remainder](accepted-strike-summatory-coprime-remainder.md)
...
52. [Accepted-Strike Cross-Layer CRT Orthogonality](accepted-strike-cross-layer-crt-orthogonality.md)
...
53. [Accepted-Strike Localized Layer Gram Matrix](accepted-strike-localized-layer-gram-matrix.md)
...
54. [Accepted-Strike First-Deletion Variance Identity](accepted-strike-first-deletion-variance-identity.md)
    - Factors the local Gram matrix by first-deletion class and identifies the
      ...
      bounds.
55. [Accepted-Strike Active Two-Class Variance Identity](accepted-strike-active-two-class-variance-identity.md)
...
56. [Accepted-Strike First-Deletion Coordinate Reindexing](accepted-strike-first-deletion-coordinate-reindexing.md)
...
57. [Endpoint-Observable Joint Capacity Envelope](endpoint-observable-joint-capacity-envelope.md)
...
58. [Endpoint Capacity Cannot Certify The Collision Budget](endpoint-capacity-cannot-certify-collision-budget.md)
...
59. [Endpoint Sampling And Strike Density Recombine Into Harmful Residues](endpoint-sampling-strike-density-harmful-residue-bridge.md)
    - Proves that #13's endpoint bias and #23's strike-density error recombine
      ...
      target.
60. [Pointwise Two-Class Margin Does Not Imply The Collision Budget](pointwise-two-class-margin-does-not-imply-collision-budget.md)
    - Constructs integral residue histograms satisfying candidate #12's full
      ...
      strictly stronger.
61. [Sharp Harmful-Residue Box Inside The Collision Ellipse](sharp-harmful-residue-box-inside-collision-ellipse.md)
...
62. [Sharp Sixfold-Capacity Harmful-Energy Envelope](sharp-sixfold-capacity-harmful-energy-envelope.md)
...
63. [Sharp Sixfold-Capacity Population-Ratio Threshold](sharp-sixfold-capacity-population-ratio-threshold.md)
...
64. [Capacity Population-Threshold Hierarchy](capacity-population-threshold-hierarchy.md)
...
65. [Late-Layer Sixfold Floor Controls Harmful Energy](late-layer-sixfold-floor-controls-harmful-energy.md)
...
66. [One-Layer Harmful Ellipses Do Not Compose](one-layer-harmful-ellipses-do-not-compose.md)
...
67. [Weighted Harmful-Excess Energy Is Already Terminal](weighted-harmful-excess-energy-is-terminal.md)
...
68. [Integral Population Profiles Attain the Harmful-Energy Threshold](integral-population-profiles-attain-harmful-energy-threshold.md)
    - Constructs, for every fixed prime chain, arbitrarily scaled integral
      ...
      deletion geometry.
69. [Harmful-Excess Energy Has an Exact Stability Decomposition](harmful-excess-energy-exact-stability-decomposition.md)
...
70. [Harmful Capacity Separates the Energy Minimizer](harmful-capacity-separates-energy-minimizer.md)
...
72. [Paired Harmful-Excess CRT Orthogonality Has Primorial Scale](paired-harmful-excess-crt-orthogonality-has-primorial-scale.md)
...
74. [Native-Period Capacity Overflow Quantifies the Hybrid Gain](native-period-capacity-overflow-quantifies-hybrid-gain.md)
...
75. [Capacity-Envelope Width Floor Needs Population Slack](capacity-envelope-width-floor-needs-population-slack.md)
...
78. [Fixed Seven Cut Cannot Clear The Original Threshold](fixed-seven-cut-cannot-clear-original-threshold.md)
...
79. [Every Fixed Native Cut Fails The Original Threshold](every-fixed-native-cut-fails-original-threshold.md)
...
80. [Moving Cut Loses Complete Native Blocks](moving-cut-loses-complete-native-blocks.md)
...
84. [Copy-Block Harmful Excess Is Controlled By Residue Energy](copy-block-harmful-excess-controlled-by-residue-energy.md)
...
85. [Relaxed Almost-Prime Weight Has An Exact Divisor Local Factor](relaxed-almost-prime-divisor-local-factor.md)
...
86. [Relaxed Almost-Prime Bilinear Remainder Has A Character Obstruction](relaxed-almost-prime-bilinear-character-obstruction.md)
...
87. [Relaxed Cofactor Divisor Sum Is A Prime-Progression Discrepancy](relaxed-cofactor-divisor-sum-is-prime-progression-discrepancy.md)
...
88. [Incremental Danger-Annulus Decomposition](incremental-danger-annulus-decomposition.md)
...
89. [Realized Filter Adversariality Score](realized-filter-adversariality-score.md)
